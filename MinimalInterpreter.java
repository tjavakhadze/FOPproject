//test 1, for now this only works for reading and printing variables, arithmetic operations, booleans and if-else statements. I will be adding further changes later.
